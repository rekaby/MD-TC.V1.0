...
public class Options implements Cloneable, Serializable {
	...
	//public boolean useContextFeatures = false;
    ...
    public String contextFile = null;
    public String contextFile2 = null;
    
	public int maxNumSent = -1;
    public int numPretrainIters = 1;
	public int maxNumIters = 1;
	public boolean initTensorWithPretrain = false;//Rekaby TODO
    ...
    public void printOptions() {
    	...
    	System.out.println("Context-file: " + contextFile);
    ...
    PossibleLang findLang(String file) {
    	...
    	if (lang != PossibleLang.Unknown && new String("english").indexOf(langString[lang.ordinal()]) != -1) {
			return lang;
		}
    	}
